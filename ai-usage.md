...
- *Accuracy of Information:* Most of the summaries of the objects and their significance were correct. However, I detected a few errors in the data that Claude pulled from the museum websites that it searched. For example, Claude got confused by a long webpage for an exhibit from the Network of Catalunyan Art Museums. On a single web page a large number of objects contained long captions. One object, a cassone, related to marriage. A description of a statue of Saint George appeared elswhere on the website. For item 13 on the list, Claude somehow merged these two object descriptions and came up with the erroneous claim that Saint George was closely connected to marriage. (Score: 3/5)
- *Quality of Explanation:* The summaries could have been better at explaining the cultural significance of the objects. In particular, the section on rings seemed to be all over the place, with no discernible rationale for including particular rings as significant for understanding marriage. Occasionally, though, the explanation was high quality, such as for the cassones and paintings of saints.  (Score 2/5)
...
- *Accuracy of Information:* I know a lot about the Archive of the Crown of Aragon and so I could identify how Claude dramatically mis-represented the divisions of the archive and left out the Patrimonio Real. With far less knowledge of the Paston letters and the Datini archive, I couldn't know for sure how much Claude was getting right or wrong, but nothing raised a red flag for me. As for the other archival sources included in the report, I was learning about those for the first time. (Score 3/5)
...
I decided to try Google Gemini for the thematic essays. It suggested the following four themes: The Politics of Alliance, The Theatre of Matrimony, Materializing the Bond, and The Lived Reality. These struck me as good ones but only if I focused on the wedding itself, with only one theme covering what came afterward. I had intended the website to be entirely about what Gemini called 'The Lived Reality.' Gemini didn't quite understand the variety of ways that the meaning of marriage included the longer-term social picture beyond the courtship and the wedding. This is a subtle distinction when writing an AI Chatbot prompt about marriage but an obvious distinction when a human is talking about marriage. This episode in my AI usage demonstrates nicely how the construction of the prompt requires multiple iterations. If I had decided to go further with this particular use of AI, I would have given Gemini a second prompt, adding a sentence such as, 'Please focus your attention on the meaning of marriage beyond the wedding itself, by which I mean the social constructions surrounding married life.'
...
When Gemini was in 'thinking mode' I observed it identify gaps in research and target new searches to fill those gaps. Unfortunately, Gemini fails to retain the record of its live thinking (something that Claude does retain). For much of the live thinking, Gemini repeatedly referenced a legal case regarding the name Corbet. This did not make it into the initial report but I got curious about it. I prompted Gemini to retrieve the information about the Corbet case and it proceeded to hallucinate a medieval court case. It also hallucinated a rationale for its significance. [Gemini's report on a hallucinated court case on Corbet →](pdfs/gemini-dramatic-research-hallucination.pdf)

**Evaluation:**
- *Usefulness:* I will credit Gemini with solid ideas, and rationales, for its thematic divisions. Had the website focused on weddings, rather than seeking to understand social constructions of marriages over the longer term of the marriage, then I think the thematic divisions here would work nicely as frames. (Score 4/5)
- *Accuracy:* Gemini did discard whatever it was thinking about whatever it found regarding the name Corbet, so that does count in the chatbot's favor. However, when attempting to get the chatbot to come up with something very granular in the historical record, it decided to hallucinate rather than admit something was not significant. (Score 2/5)
- *Interpretations:* I have doubts about the interpretive leap that Gemini took in its analysis of the role of marriage objects on page 8 of the report. Gemini claims that the objects did the 'work' of the marriage through binding, transporting, and defining. This reads to me like mimicry of the poetic moves sometimes made in scholarship but in that context always supported by much more theoretical and contextual qualification. (Score 3/5)
- *Who Did What:* Overall, I did the work of deciding on the themes for the website. Gemini's input was interesting but ultimately not useful to me in thinking through how to organize the information I wanted to communicate about what I had learned.
...
**Evaluation:**
The usage of AI in this instance was less to locate resources or produce leverage on my analytic thinking. Rather, the use of AI helped me to gain confidence in what I already knew: a highly skilled and careful scholar had accidentally mis-interpreted the sentences in this document to refer to a female servant. I think that Gampel's omission of Violant's pregnancy in the footnote confirms that he accidentally read 'prenyat' as 'female servant.'